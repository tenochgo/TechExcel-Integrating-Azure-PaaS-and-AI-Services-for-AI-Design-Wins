...
public class DatabaseService : IDatabaseService
{
    ...
    /// <summary>
    /// Retrieves all bookings for a specified hotel that start on or after a given date.
    /// </summary>
    /// <param name="hotelId">The ID of the hotel.</param>
    /// <param name="dt">The minimum start date for the bookings to be retrieved. Only bookings with a start date on or after this date will be included.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains an enumerable collection of bookings.</returns>
    /// 
    [KernelFunction]
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate( 
        ...
        [Description("The minimum srtart date for the bookings retrieved. Only bookings with a start date on or after this date will be included")] DateTime dt)
    {
